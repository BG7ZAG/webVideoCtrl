  ...
  if (!e.WebVideoCtrl) {
    var t = function () {
      ...
      var r = "100%", s = "100%", o = "", i = "", a = {
        ...
        }, c = null, u = 0, l = !1, d = [], p = [], P = null, h = null, I = null, f = null, m = this, C = null, S = 1,
        v = 2, y = 200, g = 0, x = 1, D = 2, z = 3, T = 4, b = 5, A = 6, M = 0, R = 2, L = 3, q = 21, G = -1, W = 0,
        X = "IPCamera", w = "IPDome", H = "IPZoom",
      ...
      le.prototype.CGI = {
        ...
        var c = new ue, u = {type: "PUT", url: o, async: !1, auth: e.szAuth, data: i, success: null, error: null},
          l = this;
        f.extend(u, r), f.extend(u, {
          success: function (e) {
            ...
            if (X == e.szDeviceType || H == e.szDeviceType) {
              ...
              var a = new ue, c = {type: "PUT", url: o, async: !1, auth: e.szAuth, data: i, success: null, error: null};
        ...
        var u = new ue, l = {type: "PUT", url: o, async: !1, auth: e.szAuth, data: a, success: null, error: null};
        ...
        var a = f.loadXML(r), c = parseInt(n.$XML(a).find("StartPoint").eq(0).find("positionX").eq(0).text(), 10),
        ...
        var t = 100 * t + 1, s = -1, o = E(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
          i = [];
        ...
        var u = E(this.CGI.sessionLogin, c, e, r), l = n.$XML(i).find("sessionID").eq(0).text(),
          d = n.$XML(i).find("challenge").eq(0).text(), p = parseInt(n.$XML(i).find("iterations").eq(0).text(), 10),
          P = !1, h = "";
      ...
      de.prototype.CGI = {
        ...
        var c = new ue, u = {type: "PUT", url: s, async: !1, auth: e.szAuth, data: i, success: null, error: null};
        f.extend(u, r), f.extend(u, {
          success: function (e) {
            r.success && r.success(e)
          }, error: function (e, t) {
      ...
      Pe.prototype.extend = function () {
        ...
        var e = new Date(1582, 10, 15, 0, 0, 0, 0), n = new Date, r = n.getTime() - e.getTime(), s = "-",
          o = t.getIntegerBits(r, 0, 31), i = t.getIntegerBits(r, 32, 47), a = t.getIntegerBits(r, 48, 59) + "1",
          c = t.getIntegerBits(t.rand(4095), 0, 7), u = t.getIntegerBits(t.rand(4095), 0, 7),
